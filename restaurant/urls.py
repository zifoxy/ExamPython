...
urlpatterns = [
    ...
    path('moderator/write-off/', views.moderator_write_off, name='moderator_write_off'),
    ...
    path('accountant/write-offs/', views.accountant_write_offs, name='accountant_write_offs'),
